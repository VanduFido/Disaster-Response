...
def load_data(messages_filepath, categories_filepath):
    ...
    Returns:
    df: dataframe resulting from merge of messages_filepath and categories_filepath
...
def clean_data(df):
    ...
    """
    # create a dataframe only the category columns
